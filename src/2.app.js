...
function init() {
    ...
    <div id="nav" style="display: flex; align-items: center;">
        ...
        <a href="sigmabooks.html">Sigma books</a>
        <a href="joinchannel.html">Join Channel</a>
        <a href="https://t.me/Deleech" class="btn btn-primary" style="margin-left: 10px;">Partner</a>
