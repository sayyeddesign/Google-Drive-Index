...
function init() {
    ...
    var html = `
    <header>
    <div id="nav" style="display: flex; align-items: center;">
        <!-- Existing navigation items -->
        <a href="home.html" style="margin-right: 10px;">Home</a>
        <a href="sigmabooks.html" style="margin-right: 10px;">Sigma books</a>
        <a href="joinchannel.html" style="margin-right: 10px;">Join Channel</a>
        <a href="https://t.me/Deleech" class="btn btn-primary" style="margin-right: 10px;">Partner</a>
...
<div>
    ...
    <footer class="footer mt-auto py-3 text-muted ${UI.footer_style_class}" style="${UI.fixed_footer ? 'position: fixed; ' : ''}left: 0; bottom: 0; width: 100%; color: white; z-index: 9999;${UI.hide_footer ? ' display:none;' : ' display:block;'}">
        <div class="container" style="width: auto; padding: 0 20px; display: flex;">
            ${UI.credit ? '<p style="margin: 0; flex-grow: 1; text-align: left;">Uploaded from original Sigma books channel by Sayyed <a href="https://t.me/Deleech" target="_blank">"De area"</a>, Enjoy.</p>' : ''}
            <p style="margin: 0; flex-grow: 1; text-align: right;">© ${UI.copyright_year} - <a href="https://t.me/SiGMABooks" target="_blank">Sigma books</a>, All Rights Reserved.</p>
        </div>
    </footer>
</div>
